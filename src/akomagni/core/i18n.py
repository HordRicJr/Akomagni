...
_MESSAGES: dict[str, dict[str, str]] = {
    "en": {
        ...
        "image.generated": "Image ready ({model})",
        "image.save_prompt": "Where should I save it? [{default}]",
        "image.saved": "Saved to {path}",
        "image.save_failed": "Could not save image: {error}",
        "image.skipped_save": "Not saved (press Enter next time with a path).",
        "model.picker_hint": "Model: {selection}  ·  Space or /model to change",
        ...
        "update.success": "Akomagni updated",
        "update.from_to": "  Git        : {previous} -> {current}",
        "update.version_from_to": "  Version    : {previous} -> {current}",
        "update.already_current": "  Already up to date with the release branch.",
        "update.whats_new": "  What's new:",
        "update.bmad_skills": "  BMAD kernel: {count} skills ready",
        "update.install_dir": "  Install dir : {path}",
        "update.bin_path": "  CLI binary  : {path}",
        "doctor.bmad_kernel": "  BMAD kernel : {count} skills ({path})",
        "doctor.bmad_missing": "  BMAD kernel : not found (re-run install / akomagni update)",
        "error": "Error",
    ...
    "fr": {
        ...
        "image.generated": "Image prête ({model})",
        "image.save_prompt": "Où l’enregistrer ? [{default}]",
        "image.saved": "Enregistrée : {path}",
        "image.save_failed": "Impossible d’enregistrer l’image : {error}",
        "image.skipped_save": "Non enregistrée (indique un chemin la prochaine fois).",
        "model.picker_hint": "Modèle : {selection}  ·  Espace ou /model pour changer",
        ...
        "update.success": "Akomagni mis à jour",
        "update.from_to": "  Git         : {previous} -> {current}",
        "update.version_from_to": "  Version     : {previous} -> {current}",
        "update.already_current": "  Déjà à jour sur la branche de release.",
        "update.whats_new": "  Nouveautés :",
        "update.bmad_skills": "  Noyau BMAD : {count} skills prêts",
        "update.install_dir": "  Dossier install : {path}",
        "update.bin_path": "  Binaire CLI     : {path}",
        "doctor.bmad_kernel": "  Noyau BMAD  : {count} skills ({path})",
        "doctor.bmad_missing": "  Noyau BMAD  : introuvable (relancer install / akomagni update)",
        "error": "Erreur",
