...
Akomagni documentation is maintained in **English** (canonical) and **French**.
...
See [I18N.md](I18N.md) — both languages must stay in sync when user-facing docs change.

## Quick links

| Topic | EN | FR |
|-------|----|----|
| Getting started | [en/getting-started.md](en/getting-started.md) | [fr/getting-started.md](fr/getting-started.md) |
